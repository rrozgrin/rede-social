                        ...
                        <div class="absolute">
                            ...
                            <div v-else>
                                <button @click="cancelAvatarImage"
                                    class="inline-flex mr-1 opacity-60 bg-purple-50 hover:opacity-100 rounded-full hover:bg-purple-800  mb-2 text-purple-900 hover:text-purple-50 py-1 px-1 text-xs items-center">
